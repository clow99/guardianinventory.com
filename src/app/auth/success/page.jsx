...
function SuccessInner() {
    ...
    const message =
        params.get("message") || "Your request completed successfully.";
        ...
        <main className="min-h-screen bg-gradient-to-br from-neutral-900 to-neutral-800">
            <div className="container mx-auto px-4 py-8 flex min-h-screen items-center justify-center">
                <motion.div
                    ...
                    className="w-full max-w-lg mx-auto p-8 bg-neutral-800 border border-neutral-700 rounded-2xl shadow-2xl text-center"
                >
